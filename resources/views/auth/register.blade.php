  ...
  <div class="card">
    <div class="card-body register-card-body">
      ...
      <form method="POST" action="{{ route('register') }}">
        ...
        <div class="input-group mb-3">
            <input id="no_sim" type="no_sim" placeholder="no_sim" class="form-control @error('no_sim') is-invalid @enderror" name="no_sim" value="{{ old('no_sim') }}" required autocomplete="no_sim">
